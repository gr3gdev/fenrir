package io.github.gr3gdev.fenrir.server.http.impl;
...
import io.github.gr3gdev.fenrir.server.http.RemoteAddress;
...
public class RequestImpl implements Request {
    ...
    public void params(Stream<String> keys, Consumer<Map<String, String>> action) {
        final Map<String, String> values = keys
                .collect(Collectors.toMap(Function.identity(), k -> params(k).orElse("")));
