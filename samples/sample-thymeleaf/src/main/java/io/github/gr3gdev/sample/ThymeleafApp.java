...
import io.github.gr3gdev.fenrir.thymeleaf.validation.ThymeleafValidation;
...
@FenrirConfiguration(plugins = {ThymeleafValidationPlugin.class, FileLoaderPlugin.class, JpaPlugin.class}, modes = {HttpMode.class})
@HttpConfiguration(routes = {UserRoute.class, StaticRoute.class})
@JpaConfiguration(entitiesClass = {User.class, Prefs.class})
